# 02. Harness Engineering cho hệ thống AI chạy production

## 1. Tổng quan

Tài liệu này trình bày lớp Harness Engineering theo mạch: bối cảnh và vai trò, cấu trúc thành phần, cơ chế vận hành, sau đó là lộ trình triển khai để áp dụng vào hệ thống thực tế.
